...
import world.gregs.void.cache.definition.data.WorldMapDefinition
import world.gregs.void.cache.definition.data.WorldMapSection
import java.util.*
 ...
 * @since April 08, 2020
 */
class WorldMapDetailsDecoder(cache: world.gregs.void.cache.Cache) : DefinitionDecoder<WorldMapDefinition>(cache, WORLD_MAP) {
