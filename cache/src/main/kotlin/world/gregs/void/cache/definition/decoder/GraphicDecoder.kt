...
import world.gregs.void.cache.Indices.GRAPHICS
 ...
 * @since April 08, 2020
 */
class GraphicDecoder(cache: world.gregs.void.cache.Cache) : DefinitionDecoder<GraphicDefinition>(cache, GRAPHICS) {
