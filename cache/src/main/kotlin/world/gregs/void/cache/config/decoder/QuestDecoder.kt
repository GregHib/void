...
import world.gregs.void.cache.Configs.QUESTS
import world.gregs.void.cache.config.ConfigDecoder
import world.gregs.void.cache.config.data.QuestDefinition

/**
 * @author GregHib <greg@gregs.world>
 * @since April 08, 2020
 */
class QuestDecoder(cache: world.gregs.void.cache.Cache) : ConfigDecoder<QuestDefinition>(cache, QUESTS) {
