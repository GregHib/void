...
import world.gregs.void.cache.Configs.WORLD_MAP_INFO
 ...
 * @since April 08, 2020
 */
class WorldMapInfoDecoder(cache: world.gregs.void.cache.Cache) : ConfigDecoder<WorldMapInfoDefinition>(cache, WORLD_MAP_INFO) {
