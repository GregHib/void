...
class QuadField<A, B, C, D>(
    ...
    override fun writePacked(writer: Writer, index: Int, opcode: Int) {
        if (first.default == first.get(index) && second.default == second.get(index) && third.default == third.get(index) && fourth.default == fourth.get(index)) {
            return
        }
    ...
    override fun directSize(): Int = first.directSize() + second.directSize() + third.directSize() + fourth.directSize()
