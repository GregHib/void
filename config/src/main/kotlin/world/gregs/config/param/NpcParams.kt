...
object NpcParams : Parameters() {
    ...
    override val codecs = mapOf(
        ...
        IMMUNE_DISEASE to BooleanParam,
        INTERACTS to BooleanParam,
        GOD to StringParam,
        DROPS to StringParam,
        MAGIC to IntParam,
        ALLOWED_UNDER to BooleanParam,
        CRAWL to BooleanParam,
        SONG to IntParam,
        POISON to IntParam,
        RETREAT_RANGE to IntParam, // deprecated
        STUCK_LIMIT to IntParam,
        DAMAGE_CAP to IntParam,
    ...
    override val keys = mapOf(
        ...
        "immune_disease" to IMMUNE_DISEASE,
        ...
        "fishing" to FISHING,
        "crawl" to CRAWL,
        "retreat_range" to RETREAT_RANGE,
        "stuck_limit" to STUCK_LIMIT,
        "damage_cap" to DAMAGE_CAP,
    )
    ...
    const val IMMUNE_DISEASE = 10_062
    ...
    const val CRAWL = 10_078
    const val RETREAT_RANGE = 10_079
    const val STUCK_LIMIT = 10_080
    const val DAMAGE_CAP = 10_081
