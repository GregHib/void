...
adminCommand("reload nav graph", "reload any type of content or file e.g. npcs, object defs, or settings", aliases = listOf("reload ai graph")) {
    get<NavigationGraph>().load()
}
