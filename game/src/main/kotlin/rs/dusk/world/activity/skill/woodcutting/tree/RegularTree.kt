...
enum class RegularTree(
    ...
    Teak_Tree(RegularLog.Teak_Logs, 35, 85.0, 0.125, 15..46, 4..8, 15..24, 40..80),
    Maple_Tree(RegularLog.Maple_Logs, 45, 100.0, 0.125, 8..25, 2..4, 6..12, 58..125),
    Acadia_Tree(RegularLog.Acadia_Logs, 47, 92.0, 0.125, 15..46, 4..8, 15..24, 50..100),
    ...
    Mahogany_Tree(RegularLog.Mahogany_Logs, 50, 125.0, 0.125, 8..25, 2..4, 9..13, 70..140),
    Yew_Tree(RegularLog.Yew_Logs, 60, 175.0, 0.125, 4..12, 1..2, 3..7, 100..200),
