...
fun petRowForItem(itemId: String): RowDefinition? = Tables.get("pets").rows().firstOrNull {
    itemId == it.itemOrNull("baby_item") || itemId == it.itemOrNull("grown_item") || itemId == it.itemOrNull("overgrown_item")
}

fun petRowForNpc(npcId: String): RowDefinition? = Tables.get("pets").rows().firstOrNull {
    npcId == it.npcOrNull("baby_npc") || npcId == it.npcOrNull("grown_npc") || npcId == it.npcOrNull("overgrown_npc")
}
