...
internal suspend fun Player.slayerMasterChat(master: String) {
    if (master == "turael" && slayerTasks == 0) {
...
private suspend fun Player.roll(master: String) {
...
private suspend fun Player.teachMe(master: String) {
    choice {
