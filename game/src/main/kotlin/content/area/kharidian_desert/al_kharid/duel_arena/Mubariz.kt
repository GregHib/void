...
class Mubariz : Script {
    ...
    fun ChoiceOption.place(): Unit = option<Uncertain>("What is this place?") {
    ...
    fun ChoiceOption.options(): Unit = option<Uncertain>("What kind of options are there?") {
    ...
    fun ChoiceOption.exit(): Unit = option<RollEyes>("I'll be off.") {
