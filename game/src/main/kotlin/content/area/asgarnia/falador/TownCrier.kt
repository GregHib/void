...
class TownCrier : Script {
    ...
    private val currentOverheads = listOf(
        "The Wilderness is back! Are you brave enough to venture in?",
        "Dungeoneering is now available! Visit Daemonheim to start your adventure!",
        "Summoning familiars are here to aid you in combat!",
        "Bonfires are now available for Firemaking training!",
        "Clan Citadels are opening soon! Prepare your clan!",
        "The Troll Warzone is now open for business!",
    )
    ...
    private val historicalOverheads = listOf(
        "The Grand Exchange has been updated!",
        "Have you checked out the latest game updates?",
        "New quests are available! Check your Quest Journal!",
        "Stealing Creation is a great way to earn bonus XP!",
        "Have you tried Player-Owned Houses yet?",
        "The Loyalty Programme rewards you for membership!"
    )
    ...
    private val activeOverhead: String
        get() {
            ...
            return when {
                ...
                currentMonth == Month.MARCH || currentMonth == Month.APRIL -> "Happy Easter!"
                else -> {
    ...
    init {
        ...
        npcOperate("Talk-to", "town_crier_falador") {
            ...
            choice {
                option("Tell me about Player Moderators.") {
                    player<Neutral>("Tell me about Player Moderators.")
                    npc<Neutral>("Of course. What would you like to know?")

                    choice {
                        option("What is a Player Moderator?") {
                            player<Neutral>("What is a Player Moderator?")
                        ...
                        option("What can Player Moderators do?") {
                            player<Neutral>("What can Player Moderators do?")
                        ...
                        option("How do I become a Player Moderator?") {
                            player<Neutral>("How do I become a Player Moderator?")
                        ...
                        option("What can Player Moderators not do?") {
                            player<Neutral>("What can Player Moderators not do?")
                ...
                option("Tell me about the Rules of RuneScape.") {
                    player<Neutral>("Tell me about the Rules of RuneScape.")
                    npc<Neutral>("At once. Take a look at my book here.")
                    // TODO: Open Rules of RuneScape book interface
                }
                option("Can you give me a handy tip please?") {
                    player<Neutral>("Can you give me a handy tip please?")
