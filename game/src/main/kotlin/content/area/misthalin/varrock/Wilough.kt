...
suspend fun Player.gertrudeUnstarted() {
...
private suspend fun Player.lookingForInformationBranch() {
    ...
    choice {
        option<Angry>("Tell me sonny, or I will inform your mum you are a pair of criminals.") {
            ...
            npc<Happy>(npcId = SHILOP_STRING_NAME, "And I'm even more her favourite than he is!")
...
suspend fun Player.gertrudeFluffsCost() {
    npc<Neutral>("Well... Now you ask, I'm a bit short on cash.")
    player<Idle>("How much?")
    npc<Happy>("100 coins should cover it.")
    player<Angry>("100 coins! What sort of expensive things do you need that badly?")
    npc<Happy>("Well I Don't like chocolate and have you seen how much sweets cost to buy?")
    player<Quiz>("Why should I pay you then, can you answer that as easily?")
    npc<Idle>("Obviously you shouldn't pay that much, but I won't help otherwise. I never liked that cat anyway, fussy scratchy thing it is, so what do you say?")
    choice {
...
suspend fun Player.gertrudeLookingForInformation() {
    ...
    npc<Shock>("I didn't mean to take it! I just forgot to pay.")
