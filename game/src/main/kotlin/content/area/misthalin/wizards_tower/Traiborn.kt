...
class Traiborn : Script {
    ...
    fun ChoiceOption.thingummywut(): Unit = option<Uncertain>("What's a thingummywut?") {
    ...
    fun ChoiceOption.betterBeOff(): Unit = option<Talk>("Err I'd better be off really.") {
        npc<Uncertain>("Oh ok, have a good time, and watch out for sheep! They're more cunning than they look.")
    }

    fun ChoiceOption.teachMe(): Unit = option<Talk>("Teach me to be a mighty and powerful wizard.") {
    ...
    fun ChoiceOption.youLookedAfterIt(): Unit = option<Talk>("He told me you were looking after it for him.") {
    ...
    fun ChoiceOption.needAKey(): Unit = option<Talk>("I need to get a key given to you by Sir Prysin.") {
    ...
    fun ChoiceOption.kingsKnight(): Unit = option<Talk>("He's one of the King's knights.") {
    ...
    fun ChoiceOption.anyKeys(): Unit = option<Talk>("Well, have you got any keys knocking around?") {
    ...
    fun ChoiceOption.keyForSilverlight(): Unit = option<Talk>("It's the key to get a sword called Silverlight.") {
    ...
    fun ChoiceOption.justTellMe(): Unit = option<Talk>("Just tell me if you have the key.") {
