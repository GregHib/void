...
class TempleDoor : Script {
    ...
    private suspend fun Player.droneVoicesProgress3() {
        ...
        statement(
            "<col=000080>HAHAHAHA nothing buddy! We're just so grateful to you!<br>" +
    ...
    private suspend fun Player.droneVoicesProgress2() {
        ...
        statement(
            "<col=800000>You'll do this for good old Delzig won't ya buddy?<br>" +
    ...
    private suspend fun Player.droneVoicesProgress1() {
        ...
        choice {
            option<Neutral>("Roald sent me to check on Drezel.") {
                ...
                statement(
                    "<col=800000>Ah, good, well, I don't think...<br>" +
                ...
                choice {
                    option("Sure.") {
                        ...
                        pipProgress = 2
                        statement(
                            " <col=800000>HAHAHAHA! Really? Thanks buddy! You see that mausoleum out" +
                    ...
                    option("Nope.") {
                        ...
                        statement(
                            "<col=800000>Get lost then! I have important things to do, as sure as my name is" +
