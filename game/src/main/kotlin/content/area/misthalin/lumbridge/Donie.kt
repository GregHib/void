...
class Donie : Script {
    ...
    suspend fun ChoiceBuilder2.whereAmI(): Unit = option<Quiz>("Where am I") {
    ...
    suspend fun ChoiceBuilder2.howToday(): Unit = option<Quiz>("How are you today?") {
    ...
    suspend fun ChoiceBuilder2.anyQuests(): Unit = option<Quiz>("Are there any quests I can do here?") {
    ...
    suspend fun ChoiceBuilder2.shoeLace(): Unit = option<Chuckle>("Your shoe lace is untied.") {
        npc<Angry>("No it's not!")
        player<Chuckle>("No you're right. I have nothing to back that up.")
        npc<Angry>("Fool! Leave me alone!")
    }

    suspend fun ChoiceBuilder2.buyStick(): Unit = option<Quiz>("Can i buy your stick?") {
    ...
    suspend fun ChoiceBuilder2.freeStuff(): Unit = option<Quiz>("Do you have anything of value which I can have?") {
    ...
    suspend fun ChoiceBuilder2.hairCut(): Unit = option<Quiz>("Where can I get a haircut like yours?") {
