...
class LumbridgeGuardsman : Script {
    ...
    suspend fun ChoiceBuilder2.tellMeGuardsmen(): Unit = option<Quiz>("Tell me about the Lumbridge Guardsmen.") {
    ...
    suspend fun ChoiceBuilder2.aroundHere(): Unit = option<Quiz>("What is there to do around here?") {
        when (random.nextInt(0, 2)) {
    ...
    suspend fun ChoiceBuilder2.tellMeLumbridge(): Unit = option<Quiz>("Tell me about Lumbridge.") {
        when (random.nextInt(0, 3)) {
    ...
    suspend fun ChoiceBuilder2.whatAreGuarding(): Unit = option<Quiz>("What exactly are you guarding?") {
        when (random.nextInt(0, 2)) {
