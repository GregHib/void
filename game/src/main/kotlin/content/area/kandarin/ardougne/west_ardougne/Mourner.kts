...
npcOperate("Talk-to", "mourner_elena_guard_vis") {
    if (player.holdsItem("warrant")) {
        ...
        val otherGuard = npcs.get(if (target.tile.equals(2539, 3273)) Tile(2534, 3273) else Tile(2539, 3273)).first { it.id == "mourner_elena_guard_vis" }
        ...
        val door = objects.get(doorTile, "door_597_closed")!!
