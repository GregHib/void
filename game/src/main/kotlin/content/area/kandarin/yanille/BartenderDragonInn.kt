...
class BartenderDragonInn : Script {
    ...
    init {
        ...
        itemOnNPCOperate("zogre_sithik_portrait_bad", "bartender_dragon_inn") {
            ...
            npc<Happy>("Who's that? I mean, I guess it's a picture of a person isn't it? Sorry...you've got me? And before you ask, you're not putting it up on my wall!")
            player<Shifty>("It's a portrait of Sithik Ints...don't you recognise him?")
            npc<Shifty>("I'm sorry, I really am, but I just don't see it...can you make a better picture?")
            player<Sad>("I'll try...")
        }
        ...
        itemOnNPCOperate("zogre_sithik_portrait_good", "bartender_dragon_inn") { (target) ->
            ...
            if (get("thzfe_innkeepermugshown", false)) {
                npc<Neutral>("Yeah, I recognise that Geezer, he was talking to one of my customers the other day.")
            } else {
                signPortrait(target)
            }
        }
    ...
    private suspend fun Player.tankardFirstTime() {
        player<Neutral>("Hello there, I found this tankard in an ogre tomb cavern. It has the emblem of this Inn on it and I wondered if you knew anything about it?")
        set("thzfe_showntankard", true)
        npc<Neutral>("Oh yes, this is Brentle's mug...I'm surprised he left it just lying around down some cave. He's quite protective of it.")
        player<Neutral>("Brentle you say? So you knew him then?")
        npc<Neutral>("Yeah, this belongs to 'Brentle Vahn', he's quite a common customer, though I've not seen him in a while.")
        npc<Shifty>("He was talking to some shifty looking wizard the other day. I don't know his name, but I'd recognise him if I saw him.")
        player<Neutral>("Hmm, I'm sorry to tell you this, but Brentle Vahn is dead - I believe he was murdered.")
        npc<Shock>("Noooo! I'm shocked...")
        npc<Neutral>("...but not surprised. He was a good customer...but I knew he would sell his sword arm and do many a dark deed if paid enough.")
        npc<Sad>("If you need help bringing the culprit to justice, you let me know.")
    }

    // ===== Repeat tankard showing =====

    private suspend fun Player.tankardRepeat() {
        player<Happy>("Hello again. Can you tell me what you know about this tankard again please?")
        npc<Neutral>("Oh yes, Brentle's tankard. Yeah, you've shown me this already. It belonged to Brentle Vahn, he was quite a common customer, though I've not seen him in a while.")
        npc<Shifty>("He was talking to some shifty looking wizard the other day. I don't know his name, but I'd recognise him if I saw him.")
    }
    ...
    private suspend fun Player.signPortrait(npc: NPC) {
        npc<Neutral>("Yeah, that's the guy who was talking to Brentle Vahn the other day! Look at those eyes, never a more shifty looking pair will you ever see!")
        player<Neutral>("Hmm, you've just identified the man who I think sent Brentle Vahn to his death.")
        player<Neutral>("I'm trying to bring him to justice with the Wizards' Guild grand secretary. Do you think you could sign this portrait to say that he was talking to Brentle Vahn.")
