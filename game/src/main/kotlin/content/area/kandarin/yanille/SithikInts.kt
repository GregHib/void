...
class SithikInts : Script {
    init {
        ...
        itemOnObjectOperate("necromancy_book", "zogre_sithik_bed_entity,ogre_bedman_loc") {
            ...
            sithik<Neutral>("Oh..I'm not quite sure actually...where did you find that then?")
            player<Neutral>("I found it in this cupboard! What do you have to say for yourself?")
            sithik<Neutral>("Oh yes, that's right...I remember now. It's for my research, there's nothing really dangerous about it, unless it falls into the wrong hands. I'm sure it's pretty safe with me.")
        ...
        itemOnObjectOperate("book_of_ham", "zogre_sithik_bed_entity,ogre_bedman_loc") {
            ...
            sithik<Neutral>("What do you mean? It's a book by the respected HAM leader Johanhus Ulsbrecht, that man speaks for a lot of people who are unhappy with the current state of affairs.")
            sithik<Angry>("Can you honestly tell me that you've not had to fight for your life against the odd monster or two?")
            player<Neutral>("Hmm, that may be true, but I don't universally hate all monsters, whereas I have a sneaking suspicion that you do...and ogres in particular!")
            sithik<Angry>("Hmm, that's an interesting theory, care to back it up with any facts?")
        }
        ...
        itemOnObjectOperate("papyrus", "zogre_sithik_bed_entity,ogre_bedman_loc") {
            ...
            sithik<Happy>("Oh lovely! You're making my portrait! Let me see it afterwards!")
        ...
        itemOnObjectOperate("book_of_portraiture", "zogre_sithik_bed_entity,ogre_bedman_loc") {
            ...
            sithik<Neutral>("It's my hobby...I'm interested in portraiture, but all art in general. It's fun, you should try it.")
            player<Neutral>("How do I do it...")
            sithik<Neutral>("Well...you could start by reading the book!")
        }
        ...
        itemOnObjectOperate("zogre_sithik_portrait_bad", "zogre_sithik_bed_entity,ogre_bedman_loc") {
            ...
            sithik<Happy>("Hmmm, well it's an interesting interpretation, but not really classic realist representation is it? It's not my favourite, but I like the 'truth' of the work...well done.")
        }
        ...
        itemOnObjectOperate("zogre_sithik_portrait_good", "zogre_sithik_bed_entity,ogre_bedman_loc") {
            ...
            sithik<Happy>("Hmmm, well it's not the most flattering of portraits, but I like the 'honesty' of the work...well done.")
        }

        // ===== Strange potion =====
        itemOnObjectOperate("zogre_ogre_trans_potion", "zogre_sithik_bed_entity,ogre_bedman_loc") {
            player<Neutral>("Here, try some of this potion, it'll make you feel better!")
            sithik<Shock>("Err, yuck....no way am I taking any potions or medication off you...I don't trust you!")
        }

        // ===== Signed portrait (the bribe scene) =====
        itemOnObjectOperate("signed_portrait", "zogre_sithik_bed_entity,ogre_bedman_loc") {
            player<Neutral>("Hey, what do you think of this? I'm going to show it to Zavistic and you're going to be in trouble!")
            item(item = "signed_portrait", text = "You show the portrait to Sithik.")
            sithik<Shifty>("Hmmm, well, I've got quite a common looking face, I'm often mistaken for other wizards, you know, when I'm wearing my wizard's hat, robes and staff. There's a lot of us around here you know.")
            player<Neutral>("I don't think so! This is a signed picture of you, someone recognised you, you're in deep trouble!")
            sithik<Shifty>("Ok, I'll pay you to keep this secret - how much do you want for the picture?")
            player<Angry>("You can't buy me Sithik!")
            sithik<Shifty>("Ok, let's say two million...two million to keep quiet and give me the picture.")
            ...
            sithik<Shifty>("Yes, and you deserve it, you're very clever! Now, take the money...")
            bribeChoice()
        }
        ...
        itemOnObjectOperate("dragon_inn_tankard", "zogre_sithik_bed_entity,ogre_bedman_loc") {
            ...
            sithik<Angry>("You probably found it at the local brewhouse! It doesn't take a genius to figure that one out.")
            player<Happy>("Aha! But I found this in an old ogre tomb! I suspect it's a clue which will lead me to the suspect.")
            sithik<Shifty>("Hmmm, well that eliminates all the local people who don't actually drink at the 'Dragon Inn'. When do you think you'll start questioning the remaining population of Yanille?")
        }
        ...
        itemOnObjectOperate("black_prism", "zogre_sithik_bed_entity,ogre_bedman_loc") {
            ...
            sithik<Angry>("Err..it looks sort of familiar, did you steal it from me? Come to think of it, you have the appearance of a common thief!")
            player<Neutral>("I found it in a place called Jiggig where some undead ogres happen to be wandering around.")
            sithik<Shifty>("Oh, nothing to do with me then, never seen it in my life before!")
        }
        ...
        itemOnObjectOperate("torn_page", "zogre_sithik_bed_entity,ogre_bedman_loc") {
            ...
            sithik<Angry>("It's probably a piece of rubbish someone threw away...what does it say, I can't read it?")
            player<Neutral>("You should be able to read it, it's been torn from a book on necromancy and you're meant to be a specialist in the subject.")
            sithik<Shifty>("Oh, no..., not really a specialist, just a hobby of mine really. Hardly know anything about it, but it does seem interesting...")
        }
    }
    ...
    private suspend fun Player.sleepyOldManIntro() {
        sithik<Neutral>("Hey...who gave you permission to come in here! Get out, get out I say.")
    ...
    private suspend fun Player.conversationByVarbit488() {
        when (get("thzfe_prismsearch", 0)) {
            4 -> {
                sithik<Neutral>("Hey...who gave you permission to come in here!")
                zavisticIntro()
            }
            5 -> {
                sithik<Neutral>("What do you want now?")
                noNeedToBeRude()
            }
    ...
    private suspend fun Player.zavisticIntro() {
        player<Neutral>("Zavistic Rarve said that I could come and talk to you and ask you a few questions.")
        sithik<Confused>("Oh, Zavistic...why...why would he send you to me?")
        sithikQuestionsMenu()
    }
    ...
    fun ChoiceOption.askAboutUndeadOgres(): Unit = option<Neutral>("Do you know anything about the undead ogres at Jiggig?") {
        ...
        sithik<Happy>("Anyway, dead ogres you say? How strange? That must be a strange sight?")
        player<Neutral>("Very well, if you don't know anything about it, you won't mind if I look around then?")
        provokedLookAround()
    }

    fun ChoiceOption.askWhatYouDo(): Unit = option<Neutral>("What do you do?") {
        sithik<Neutral>("I'm a scholarly student of the magical arts. When I was younger I used to be an adventurer, probably just like yourself. But I lost interest in the constant fighting, looting and gaining abilities.")
        sithik<Neutral>("Instead I decided to focus my attention and time to study the purer form of the lost arts.")
        player<Neutral>("The lost arts? What are they?")
        sithik<Neutral>("Ignorant people call them the 'dark arts'. I'm talking about Necromancy, the power to bring the dead back to life - the power of the gods! Surely the most awesome power known to man.")
        player<Neutral>("Hmm, well I guess I must be an ignorant person then, because bringing the dead back to life sounds very unnatural.")
        sithikQuestionsMenu()
    }
    ...
    private suspend fun Player.provokedLookAround() {
        ...
        sithik<Angry>("Well, err....well, actually yes I do mind...it's my place and I don't want strangers going through my things.")
        player<Neutral>("Well, I'm going to have a look around anyway, if you're not involved in this whole thing, you won't have anything to hide.")
        sithik<Angry>("Why, if I was a few years younger I'd give you a good hiding!")
        player<Neutral>("I'm sure!")
        sithikQuestionsMenu()
    }

    private suspend fun Player.triedAlready() {
        sithik<Angry>("I've already told you that I do! But you'll probably just ignore me again!")
    ...
    private suspend fun Player.noNeedToBeRude() {
        ...
        sithik<Neutral>("What do you expect when you just go snooping around a person's place against their express permission.")
        snoopMenu()
    }
    ...
    fun ChoiceOption.whyInBed(): Unit = option<Neutral>("Why do you spend most of your time in bed?") {
        sithik<Neutral>("I'm actually quite old and not so very well and I'd like to get over this illness I have, then I'll return to my very serious and important studies.")
        sithikQuestionsMenu()
    }
    ...
    private suspend fun Player.ogreFormConfession() {
        sithik<Neutral>("Arghhhh..what's happened to me...you beast!")
        player<Neutral>("It's your own fault, you shouldn't have lied about your involvement with the undead Ogres at Jiggig. The potion will wear off once you've told the truth!")
        sithik<Neutral>("Ok, ok, I admit it, I got Brentle Vahn to cast the spell to put an end to those awful Ogres...they're just disgusting creatures...")
    ...
    fun ChoiceOption.getRidOfOgres(): Unit = option<Neutral>("How do I get rid of the undead ogres?") {
        if (get("thzfe_makebrutalarrow", false)) {
            sithik<Shock>("Haven't I already explained this to you once before?")
    ...
    private suspend fun Player.explainBrutalArrows() {
        sithik<Happy>("Ok, similar spells have been cast before and the only way to deal with the resulting creatures is to cordon off the area and not go in there again.")
        sithik<Neutral>("The undead creatures usually manifest some sort of disease so it's best to attack them from a distance with a ranged weapon.")
        sithik<Sad>("Normal missiles like arrows and darts do very little damage to them because they're designed to destroy internal organs. This is a waste of time with undead creatures like undead ogres.")
        player<Neutral>("Yeah, clearly so what should we use?")
        set("thzfe_makebrutalarrow", true)
        sithik<Sad>("From my research it looks like a flat ended arrow was designed called a 'Brutal arrow'. This does large amounts of crushing damage to the creature. You can make them by using larger arrows. ")
        sithik<Neutral>("I think some Ogre hunters make them. But instead of adding an arrow tip, you hammer a large nail into the end of the shaft.")
        confessionAnswersMenu()
    }

    fun ChoiceOption.getRidOfDisease(): Unit = option<Neutral>("How do I get rid of the disease?") {
        if (get("thzfe_makecuredisease", false)) {
            sithik<Shock>("Haven't I already explained this disease thing to you once before?")
            ...
            sithik<Shock>("No...noo...please, I'll tell you.")
            explainDiseaseCure()
        } else {
            explainDiseaseCure()
        }
    ...
    private suspend fun Player.explainDiseaseCure() {
        ...
        sithik<Sad>("My research shows that two jungle based herbs can be used, one is found near river tributaries and looks like a vine, the other is found in caves and grows on the wall.")
        sithik<Neutral>("It's quite well camouflaged so it's unlikely that you'll find it.")
        player<Neutral>("We'll see about that!")
        confessionAnswersMenu()
    }

    fun ChoiceOption.sorryHaveToGo(): Unit = option<Neutral>("Sorry, I have to go.") {
        sithik<Shock>("But...you can't just leave me here like this!")
    }

    // ===== Progress 8: Returns post-confession =====

    private suspend fun Player.postQuestProgressed() {
        sithik<Shock>("Arghhhh..what do you want now...you've turned me into a beast!")
        player<Neutral>("I've got some questions for you...and you'd better answer them well or else!")
        sithik<Shock>("Ok, ok, I'll tell you anything, just turn me back into a human again!")
        confessionAnswersMenu()
    }
    ...
    private suspend fun Player.backToGloat() {
        sithik<Neutral>("Oh, so you're back then, come to gloat have you?")
    ...
    private suspend fun Player.snoopWarning() {
        sithik<Angry>("Hey! What do you think you're doing?")
        player<Neutral>("Erk! I'd better not start rifling through peoples things without permission.")
    }
    ...
    private suspend fun Player.searchDrawer() {
        ...
        if (spaceNeeded > 0 && inventory.spaces < spaceNeeded) {
            statement("You see some items in the drawer, but you need $spaceNeeded free inventory spaces to take them.")
            return
        }
    ...
    private suspend fun Player.searchWardrobe() {
        ...
        item(item = "book_of_ham", "You find a book on Philosophy written by the 'Human's Against Monsters' leader, Johanhus Albrect.")
    }
    ...
    fun ChoiceOption.refuseBribe(): Unit = option<Neutral>("No, I won't take the money, I'm going to bring you to justice!") {
        sithik<Angry>("Oh well, suit yourself! I wasn't going to give you the money anyway! No one will believe some crazy adventurer and an Inn keep.")
    }

    fun ChoiceOption.acceptBribe(): Unit = option<Neutral>("Ok, I'll shut up for two million!") {
        sithik<Happy>("Ha! Ha! You believed me! I'm not going to give you all my money! No one will believe a crazy adventurer and a local Inn keep!")
        player<Neutral>("You're a mean and cruel man Sithik, a mean and cruel man!")
    }

    // Picks the right chathead id depending on whether the player has transformed Sithik into an ogre.
    private suspend inline fun <reified T : Expression> Player.sithik(text: String) {
        val ogre = get("thzfe_sithik_transformed", 0) >= 1
        val npcId = if (ogre) "zogre_sithik_ogre" else "zogre_sithik_man"
        npc<T>(npcId, text)
    }
}
