...
class Luke : Script {
    init {
        npcOperate("Talk-to", "50_luke") { (target) ->
            ...
            npc<Neutral>(
                "Begone afore I take my cutlass to ye! I've been charged with guardin' this " +
                    "gate and no noodle-armed landlubbers will make it past me alive!",
            )
            ...
            npc<Sad>(
                "Arrr... just 'cos me body happens to be 50% wood does not mean I'm heartless.",
            )
    ...
    fun ChoiceOption.whatHappened(): Unit = option<Quiz>("What happened to you?") {
        ...
        npc<Shifty>(
            "I have to lad, Cap'n Donnie will flay what little is left of me if I told ye.",
        )
        npc<Neutral>(
            "But anyway, I got recruited to the zombie pirates along with the rest of the " +
                "crew in an unspecified incident involvin this albatross.",
        )
        npc<Neutral>(
            "We was sailin' along happily, and I was partakin' of a little 'rum' in the crows " +
                "nest.",
        )
        npc<Sad>("Well, we hit either a really rough wave or some rocks.")
        npc<Happy>(
            "Twas kind of hard for me to tell which, as I was well out of it by then!",
        )
        ...
        npc<Neutral>(
            "What happened next was that I discovered a new, previously uncharted reef of " +
                "hard, spiky coral.",
        )
        npc<Neutral>(
            "I made a mental note of its location, and to this day it is still marked on our " +
                "fleet's charts as Lukes Reef.",
        )
        npc<Neutral>(
            "I managed to grab a hold of our ship, the Inebriated, as it passed overhead.",
        )
        npc<Sad>(
            "And then I discovered another, taller, spikier reef of even sharper and more " +
                "painful coral.",
        )
        npc<Neutral>(
            "To this day it is still marked on our fleet's charts as The Other 50% Reef.",
        )
        player<Shock>("Owwwwwwwww...")
        npc<Sad>("It gets worse...")
        npc<Neutral>(
            "When they hauled what was left of me on deck, they dropped me onto the floor " +
                "while they decided what to do with me.",
        )
        npc<Neutral>(
            "Bear in mind this would be on a ghost ship, the planks of which sweat a thick " +
                "mixture of stagnant water...and pure salt crystals.",
        )
        player<Shock>("Oh...my...god...")
        npc<Happy>(
            "But on the good side, all my thrashin' and pained squealin' settled the matter in " +
                "the Captain's mind, and he had the shipwright carve me half a body out of his " +
                "Witchwood Planks.",
        )
    ...
    fun ChoiceOption.whatsGoingOn(): Unit = option<Quiz>("So what is going on here anyway?") {
        ...
        player<Quiz>(
            "Well if you can't tell me, perhaps you could show me through the medium of " +
                "Interpretive Dance?",
        )
        npc<Neutral>("No. Just...no.")
        player<Quiz>("Mime?")
        npc<Angry>(
            "Look, lad I'm not tellin' ye a thing! So clear out while ye still can!",
        )
    }
