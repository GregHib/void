...
class LordRologarth : Script {
    ...
    private suspend fun Player.firstMeeting() {
        ...
        npc<Neutral>(
            "I was Rologarth, Lord of the North Coast - this castle was once mine. Fenkenstrain " +
                "was the castle doctor.",
        )
        player<Shock>("So this castle wasn't really abandoned when he found it?")
        npc<Sad>(
            "Is that what he told you? No, no, this castle was once full of people and life. " +
                "Fenkenstrain advised me to sell them to the vampires, which - I am sad to say - I did.",
        )
        player<Sad>("I found your brain in a jar in Canifis, so he must have sold you too.")
        npc<Sad>(
            "Of that I will not speak. There lie memories that should rest with the dead, the " +
                "living unable to bear them.",
        )
        player<Sad>( // TODO check anim
            "That's it - I'm leaving this dreadful place, whether I get paid or not. Is there " +
                "anything I can do for you before I leave?",
        )
        set("creature_of_fenkenstrain", "creature_convinced")
        npc<Neutral>(
            "Only one - please stop Fenkenstrain from carrying on his experiments, once and for " +
                "all, so that no other poor soul has to endure suffering such as that of my " +
                "people and I.",
        )
    }
    ...
    private suspend fun Player.howToStopFenkenstrain() {
        ...
        npc<Neutral>(
            "The Ring of Charos has many powers, but Fenkenstrain has bent them to his own evil " +
                "purposes. Without the power of the ring, he will not be able to raise the dead " +
                "from their sleep.",
        )
        npc<Neutral>(
            "It has one other, extremely important use - it confuses the werewolves' senses, " +
                "making them believe that they smell one of their own kind. Without the ring, " +
                "Fenkenstrain will be at their mercy.",
        )
    }
    ...
    private suspend fun Player.postQuestChat() {
        ...
        npc<Neutral>(
            "I saw him climb up into the Tower to hide. It doesn't matter - soon the werewolves " +
                "will come for him, and his experiments will be forever ceased.",
        )
        player<Quiz>("Do you want the ring back? It is yours after all.")
        npc<Neutral>(
            "No, you keep it, my friend. Werewolves hunger for the scent of live flesh. I have " +
                "no need for the ring. I have my castle back, if not my soul.",
        )
    }
}
