...
class FillimanTarlock : Script {
    ...
    init {
            ...
            when {
                ...
                stage == 70 -> {
                    ...
                    if (inventory.contains("silver_sickle")) {
                        ...
                        npc<Neutral>("My friend, I will bless it for you and you will then be able to accomplish great things. Now then, I must cast the enchantment. You can bless a new sickle by dipping it in the holy water of the grotto.")
                        blessSickleScene()
                    } else {
        ...
        itemOnNPCOperate("mirror", "filliman_tarlock_ghost") { (target) ->
            npcTile = target.tile
            talkWith(target)
            ...
            when (questStage("nature_spirit")) {
                20 -> mirrorScene()
                in 25..109 -> npc<Happy>("Oh, keep hold of that, I may need it later.")
                else -> statement("The spirit doesn't seem interested in this right now.")
            }
        }

        itemOnNPCOperate("journal_nature_spirit", "filliman_tarlock_ghost") { (target) ->
            npcTile = target.tile
            talkWith(target)
            if (!equipment.contains("ghostspeak_amulet")) {
                npc<Neutral>("Woooo wooo wooo wooo")
    ...
    private suspend fun Player.earlyEncounter() {
        if (equipped(EquipSlot.Amulet).id != "ghostspeak_amulet") {
            ...
            if (questStage("nature_spirit") < 10) {
    ...
    private suspend fun Player.convinceHesAGhost() {
        if (questStage("nature_spirit") < 20) {
            set("nature_spirit", "hes_a_ghost")
        }
        choice {
            wearingAmulet()
            howLongGhost()
    ...
    private fun ChoiceOption.howLongGhost() = option<Neutral>("How long have you been a ghost?") {
        ...
        npc<Sad>("Don't be silly, I can see you, I can see that tree. If I were dead, I wouldn't be able to see anything. What you say just doesn't reflect the truth. You'll have to try harder to pull one over on me!")
        convinceHesAGhost()
    }

    private fun ChoiceOption.whatLikeBeingGhost() = option("What's it like being a ghost?") {
        ...
        player<Neutral>("But you are a ghost, look at yourself! I can see straight through you! You're as dead as this swamp! Err... No offence or anything...")
        npc<Sad>("No I won't take offence because I'm not dead and I'm afraid you'll have to come up with some pretty conclusive proof before I believe it. What a strange dream this is.")
        convinceHesAGhost()
    }

    private fun ChoiceOption.wearingAmulet() = option<Neutral>("I'm wearing an amulet of ghost speak!") {
        ...
        npc<Sad>("You have come to haunt my dreams until I pass on your message to a dearly loved one. I understand. Pray, tell me who would you like me to pass a message on to?")
    ...
    private suspend fun Player.mirrorScene() {
        ...
        player<Neutral>("Here take a look at this, perhaps you can see that you're utterly transparent now!")
        item(item = "mirror", text = "The spirit of Filliman reaches forward and takes the mirror.")
        npc<Quiz>("Well, that is the most peculiar thing I've ever experienced. This mirror must somehow be dysfunctional. Strange how well it reflects the stagnant swamp behind me, but there is nothing of my own visage apparent.")
        player<Neutral>("That's because you're dead! Dead as a door nail.. Deader in fact... You bear a remarkable resemblance to wormbait! Err.. No offence...")
    ...
    private suspend fun Player.planChoiceLoop() {
        choice {
            option("Being dead, what options do you think you have?") {
                player<Happy>("Being dead, what options do you think you have? I'm not trying to be rude or anything, but it's not like you have many options is it? I mean, it's either up or down for you isn't it?")
                npc<Sad>("Hmm, well you're a poetic one aren't you. Your material world logic stands you in good stead... if you're standing in the material world...")
                planChoiceLoop()
            }
            option<Neutral>("So, what's your plan?") {
                npc<Sad>("In my former incarnation I was Filliman Tarlock, a great druid of some power. I spent many years in this place, which was once a forest and I would wish to protect it as a nature spirit.")
                planChoiceLoop()
            }
    ...
    private suspend fun Player.askHowToHelp() {
        npc<Sad>("Will you help me to become a nature spirit? The directions for becoming one are a bit vague, I need three things but I know how to get one of them. Perhaps you can help collect the rest?")
        player<Neutral>("I might be interested, what's involved?")
        npc<Sad>("Well, the book says, that I need, and I quote:- 'Something with faith', 'something from nature' and 'something of the 'spirit-to-become' freely given'. Hmm, I know how to get something from nature.")
        player<Neutral>("Well, that does seem a bit vague.")
        npc<Sad>("Hmm, it does and I could understand if you didn't want to help. However, if you could perhaps at least get the item from nature, that would be a start. Perhaps we can figure out the rest as we go along.")
        item(
            item = "druidic_spell",
