...
internal suspend fun Player.darkMageChat() {
...
internal suspend fun Player.repairPouches() {
    var repaired = false
...
private fun ChoiceOption.whyNot() {
    option<Quiz>("Why not?") {
...
private fun ChoiceOption.whyAreYouHere() {
...
private fun ChoiceOption.needHelp() {
...
private fun ChoiceOption.illGo() {
...
private fun ChoiceOption.askForPouch() {
