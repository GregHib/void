...
combatSwing({ !swung() && !it.specialAttack && isDragonDagger(it.weapon) }, Priority.LOW) { player: Player ->
...
combatSwing({ !swung() && it.specialAttack && isDragonDagger(it.weapon) }) { player: Player ->
