...
enum class StarLocationData(val locationDescription: String, val location: Tile) {
    ...
    MAGE_TRAINGI_ARENA("the south of the entrance to the Mage Training Arena.", Tile(3348, 3284)),
    CRAFTING_GUILD("the Crafting Guild by the gold rocks.", Tile(2940, 3281)),
    RIMMINTON_MINING_SITE("the centre of the big mine north of Rimmington.", Tile(2974, 3240)),
    ...
    KELDAGRIM_ENTERANCE("the mine located south of cave entrance to Keldagrim.", Tile(2726, 3678)),
    ...
    ARDOUNGE_MINING_SITE("the iron rocks north of the monastery, south of East Ardougne.", Tile(2701, 3333)),
