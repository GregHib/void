...
suspend fun Context<Player>.poem() {
...
suspend fun Context<Player>.poemDone() {
...
suspend fun Context<Player>.sweptToWar() {
...
suspend fun Context<Player>.oneMore() {
...
suspend fun Context<Player>.phraseMenu() {
    choice {
...
suspend fun Context<Player>.threeSyllablesMenu() {
    choice {
...
suspend fun Context<Player>.threeSyllablesMenu2() {
    choice {
...
suspend fun Context<Player>.fightMenu() {
    choice {
...
suspend fun Context<Player>.fightMenu2() {
    choice {
        option<Talk>("Swept to war.") {
            sweptToWar()
        }
...
suspend fun Context<Player>.loreMenu() {
    choice {
        option<Talk>("Started a war.") {
            npc<Pleased>("that doesn't really fit. It needs to be three syllables long.")
            threeSyllablesMenu()
...
suspend fun Context<Player>.loreMenu2() {
    choice {
        option<Talk>("Learned to soar") {
            npc<Talk>("that doesn't really fit. It needs to imply some aggressive action, like 'started a fight'.")
            fightMenu()
...
suspend fun Context<Player>.threat() {
...
suspend fun Context<Player>.morePoem() {
...
suspend fun Context<Player>.syllablePoemMenu() {
    choice {
        option<Talk>("Storm.") {
            npc<Talk>("That doesn't really fit. It needs to rhyme with the word 'yet'.")
            rhymePoemMenu()
...
suspend fun Context<Player>.syllablePoemMenu2() {
    choice {
        option<Talk>("Debt.") {
            npc<Talk>("That doesn't really fit. It needs to mean something like 'danger'.")
            dangerPoemMenu()
...
suspend fun Context<Player>.rhymePoemMenu() {
    choice {
        option<Talk>("Debt.") {
            npc<Talk>("That doesn't really fit. It needs to mean something like 'danger'.")
            dangerPoemMenu()
...
suspend fun Context<Player>.rhymePoemMenu2() {
    choice {
        option<Talk>("Threat.") {
            threat()
        }
...
suspend fun Context<Player>.dangerPoemMenu() {
    choice {
        option<Talk>("Risk.") {
            npc<Talk>("That doesn't really fit. It needs to rhyme with the word 'yet'.")
            rhymePoemMenu()
...
suspend fun Context<Player>.dangerPoemMenu2() {
    choice {
        option<Talk>("Upset.") {
            npc<Talk>("That doesn't really fit. It needs to be one syllable long.")
            syllablePoemMenu()
...
suspend fun Context<Player>.aboutRing() {
...
suspend fun Context<Player>.mostCruel() {
...
suspend fun Context<Player>.anyIdea() {
...
suspend fun Context<Player>.writePoem() {
...
suspend fun Context<Player>.stuckOnWord() {
...
suspend fun Context<Player>.poemMenu() {
    choice {
...
suspend fun Context<Player>.syllableMenu() {
    choice {
        option<Happy>("Ham.") {
            npc<Talk>("That doesn't really fit. It needs to rhyme with the word 'day'.")
            rhymeMenu()
...
suspend fun Context<Player>.syllableMenu2() {
    choice {
        option<Happy>("Roam.") {
            npc<Talk>("That doesn't really fit. It needs to rhyme with the word 'day'.")
            rhymeMenu()
...
suspend fun Context<Player>.wordsMenu() {
    choice {
...
suspend fun Context<Player>.wordsMenu2() {
    choice {
...
suspend fun Context<Player>.rhymeMenu() {
    choice {
        option<Happy>("Lay.") {
            npc<Talk>("That doesn't really fit. It needs to mean something like 'wandering aimlessly'.")
            wordsMenu()
...
suspend fun Context<Player>.rhymeMenu2() {
    choice {
        option<Happy>("Stray.") {
            stray()
        }
...
suspend fun Context<Player>.stray() {
...
suspend fun Context<Player>.meetChieftain() {
...
suspend fun Context<Player>.showGudrun() {
...
suspend fun Context<Player>.engravedRing() {
    npc<Neutral>("Is it done? Have you created a work of magnificent beauty?")
    if (!player.ownsItem("dororans_engraved_ring")) {
...
suspend fun Context<Player>.oneMoreThing() {
    choice {
...
suspend fun Context<Player>.veryWell() {
...
suspend fun Context<Player>.whereIsShe() {
...
suspend fun Context<Player>.somethingElse() {
    choice {
...
suspend fun Context<Player>.lovePoemMenu() {
    choice {
...
suspend fun Context<Player>.lovePoem() {
...
suspend fun Context<Player>.engrave() {
...
suspend fun Context<Player>.engraveSomething() {
...
suspend fun Context<Player>.engraveMenu() {
    choice {
...
suspend fun Context<Player>.haveChisel() {
...
suspend fun Context<Player>.chiselBitClumsy() {
...
suspend fun Context<Player>.poet() {
...
suspend fun Context<Player>.identify() {
...
suspend fun Context<Player>.love() {
    npc<Amazed>("Love!")
...
suspend fun Context<Player>.getToThePoint() {
...
suspend fun Context<Player>.giveRing(): Boolean {
    if (player.inventory.isFull()) {
        statement("You don't have room for the ring. Speak to Dororan again when you have room.")
        return false
    }
...
suspend fun Context<Player>.elseGoodbye() {
    choice {
        option<Neutral>("I want to talk about something else.") {
            npc<Pleased>("What can I do for you?")
            someThingElse()
