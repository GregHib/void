...
suspend fun CharacterContext<Player>.poem() {
...
suspend fun CharacterContext<Player>.poemDone() {
...
suspend fun CharacterContext<Player>.sweptToWar() {
...
suspend fun CharacterContext<Player>.oneMore() {
...
suspend fun CharacterContext<Player>.phraseMenu() {
    choice {
...
suspend fun CharacterContext<Player>.threeSyllablesMenu() {
    choice {
...
suspend fun CharacterContext<Player>.threeSyllablesMenu2() {
    choice {
...
suspend fun CharacterContext<Player>.fightMenu() {
    choice {
...
suspend fun CharacterContext<Player>.fightMenu2() {
    choice {
        option<Talk>("Swept to war.") {
            sweptToWar()
        }
...
suspend fun CharacterContext<Player>.loreMenu() {
    choice {
        option<Talk>("Started a war.") {
            npc<Pleased>("that doesn't really fit. It needs to be three syllables long.")
            threeSyllablesMenu()
...
suspend fun CharacterContext<Player>.loreMenu2() {
    choice {
        option<Talk>("Learned to soar") {
            npc<Talk>("that doesn't really fit. It needs to imply some aggressive action, like 'started a fight'.")
            fightMenu()
...
suspend fun CharacterContext<Player>.threat() {
...
suspend fun CharacterContext<Player>.morePoem() {
...
suspend fun CharacterContext<Player>.syllablePoemMenu() {
    choice {
        option<Talk>("Storm.") {
            npc<Talk>("That doesn't really fit. It needs to rhyme with the word 'yet'.")
            rhymePoemMenu()
...
suspend fun CharacterContext<Player>.syllablePoemMenu2() {
    choice {
        option<Talk>("Debt.") {
            npc<Talk>("That doesn't really fit. It needs to mean something like 'danger'.")
            dangerPoemMenu()
...
suspend fun CharacterContext<Player>.rhymePoemMenu() {
    choice {
        option<Talk>("Debt.") {
            npc<Talk>("That doesn't really fit. It needs to mean something like 'danger'.")
            dangerPoemMenu()
...
suspend fun CharacterContext<Player>.rhymePoemMenu2() {
    choice {
        option<Talk>("Threat.") {
            threat()
        }
...
suspend fun CharacterContext<Player>.dangerPoemMenu() {
    choice {
        option<Talk>("Risk.") {
            npc<Talk>("That doesn't really fit. It needs to rhyme with the word 'yet'.")
            rhymePoemMenu()
...
suspend fun CharacterContext<Player>.dangerPoemMenu2() {
    choice {
        option<Talk>("Upset.") {
            npc<Talk>("That doesn't really fit. It needs to be one syllable long.")
            syllablePoemMenu()
...
suspend fun CharacterContext<Player>.aboutRing() {
...
suspend fun CharacterContext<Player>.mostCruel() {
...
suspend fun CharacterContext<Player>.anyIdea() {
...
suspend fun CharacterContext<Player>.writePoem() {
...
suspend fun CharacterContext<Player>.stuckOnWord() {
...
suspend fun CharacterContext<Player>.poemMenu() {
    choice {
...
suspend fun CharacterContext<Player>.syllableMenu() {
    choice {
        option<Happy>("Ham.") {
            npc<Talk>("That doesn't really fit. It needs to rhyme with the word 'day'.")
            rhymeMenu()
...
suspend fun CharacterContext<Player>.syllableMenu2() {
    choice {
        option<Happy>("Roam.") {
            npc<Talk>("That doesn't really fit. It needs to rhyme with the word 'day'.")
            rhymeMenu()
...
suspend fun CharacterContext<Player>.wordsMenu() {
    choice {
...
suspend fun CharacterContext<Player>.wordsMenu2() {
    choice {
...
suspend fun CharacterContext<Player>.rhymeMenu() {
    choice {
        option<Happy>("Lay.") {
            npc<Talk>("That doesn't really fit. It needs to mean something like 'wandering aimlessly'.")
            wordsMenu()
...
suspend fun CharacterContext<Player>.rhymeMenu2() {
    choice {
        option<Happy>("Stray.") {
            stray()
        }
...
suspend fun CharacterContext<Player>.stray() {
...
suspend fun CharacterContext<Player>.meetChieftain() {
...
suspend fun CharacterContext<Player>.showGudrun() {
...
suspend fun CharacterContext<Player>.engravedRing() {
    npc<Neutral>("Is it done? Have you created a work of magnificent beauty?")
    if (!player.ownsItem("dororans_engraved_ring")) {
...
suspend fun CharacterContext<Player>.oneMoreThing() {
    choice {
...
suspend fun CharacterContext<Player>.veryWell() {
...
suspend fun CharacterContext<Player>.whereIsShe() {
...
suspend fun CharacterContext<Player>.somethingElse() {
    choice {
...
suspend fun CharacterContext<Player>.lovePoemMenu() {
    choice {
...
suspend fun CharacterContext<Player>.lovePoem() {
...
suspend fun CharacterContext<Player>.engrave() {
...
suspend fun CharacterContext<Player>.engraveSomething() {
...
suspend fun CharacterContext<Player>.engraveMenu() {
    choice {
...
suspend fun CharacterContext<Player>.haveChisel() {
...
suspend fun CharacterContext<Player>.chiselBitClumsy() {
...
suspend fun CharacterContext<Player>.poet() {
...
suspend fun CharacterContext<Player>.identify() {
...
suspend fun CharacterContext<Player>.love() {
    npc<Amazed>("Love!")
...
suspend fun CharacterContext<Player>.getToThePoint() {
...
suspend fun CharacterContext<Player>.giveRing(): Boolean {
    if (player.inventory.isFull()) {
        statement("You don't have room for the ring. Speak to Dororan again when you have room.")
        return false
    }
...
suspend fun CharacterContext<Player>.elseGoodbye() {
    choice {
        option<Neutral>("I want to talk about something else.") {
            npc<Pleased>("What can I do for you?")
            someThingElse()
