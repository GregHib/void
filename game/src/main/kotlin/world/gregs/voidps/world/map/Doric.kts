...
suspend fun CharacterContext.noOre() {
    ...
    npc<Talking>("Not to worry, stick at it. Remember, I need 6 clay, 4 copper ore, and 2 iron ore.")
    choice {
        option<Unsure>("Where can I find those?") {
            ...
            if (player.levels.get(Skill.Mining) < 15) {
                ...
                npc<Talking>("Oh well, you could practice mining until you can. Can't beat a bit of mining - it's a useful skill. Failing that, you might be able to find a more experienced adventurer to buy the iron ore off.")
            }
        }
...
suspend fun CharacterContext.unstarted() {
    ...
    choice {
        option<Talking>("I wanted to use your anvils.") {
            npc<Talking>("My anvils get enough work with my own use. I make pickaxes, and it takes a lot of hard work. If you could get me some more materials, then I could let you use<br>them.")
            startQuest()
        }
