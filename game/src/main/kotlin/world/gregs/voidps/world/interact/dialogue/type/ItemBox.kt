...
suspend fun Context<Player>.item(item: String, zoom: Int, text: String, sprite: Int? = null) {
...
suspend fun Context<Player>.items(item1: String, item2: String, text: String) {
