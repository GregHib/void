...
on<CombatAttack>({ type == "range" && damage > 0 && target is Player && weapon.id.startsWith("karils_crossbow") && it.contains("karils_set_effect") && random.nextInt(4) == 0 }) { _: Character ->
