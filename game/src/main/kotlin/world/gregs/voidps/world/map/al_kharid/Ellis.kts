...
npcOperate({ target.id == "ellis" && option == "Talk-to" }) { player: Player ->
...
npcOperate({ target.id == "ellis" && option == "Trade" }) { player: Player ->
    player.open("tanner")
}
...
interfaceOption({ id == "tanner" && option.startsWith("Tan ") }) { player: Player ->
