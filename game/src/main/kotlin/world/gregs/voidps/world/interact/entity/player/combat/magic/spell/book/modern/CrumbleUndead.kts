...
combatSwing({ player -> !swung() && isCrumbleUndead(player.spell) }, Priority.HIGHEST) { player: Player ->
...
combatSwing({ player -> !swung() && isCrumbleUndead(player.spell) }, Priority.LOW) { player: Player ->
