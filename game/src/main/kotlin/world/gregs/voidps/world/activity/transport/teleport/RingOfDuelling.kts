...
inventory({ inventory == "inventory" && item.id.startsWith("ring_of_duelling_") && option == "Rub" }) { player: Player ->
...
inventory({ inventory == "worn_equipment" && item.id.startsWith("ring_of_duelling_") }) { player: Player ->
