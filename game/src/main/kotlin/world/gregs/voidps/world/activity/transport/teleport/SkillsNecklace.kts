...
inventory({ inventory == "inventory" && item.id.startsWith("skills_necklace_") && option == "Rub" }) { player: Player ->
...
inventory({ inventory == "worn_equipment" && item.id.startsWith("skills_necklace_") }) { player: Player ->
