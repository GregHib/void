...
fun isJavelin(item: Item) = item.id.contains("_javelin")

combatSwing({ player -> !swung() && player.fightStyle == "range" && isJavelin(player.weapon) }, Priority.HIGH) { player: Player ->
...
combatSwing({ player -> !swung() && isJavelin(player.weapon) }, Priority.LOW) { player: Player ->
