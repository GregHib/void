...
combatSwing({ player -> !swung() && player.fightStyle == "range" && isMudPie(player.weapon) }, Priority.HIGH) { player: Player ->
...
combatSwing({ player -> !swung() && isMudPie(player.weapon) }, Priority.LOW) { player: Player ->
