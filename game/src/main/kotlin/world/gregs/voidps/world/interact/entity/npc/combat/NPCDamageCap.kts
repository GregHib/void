...
on<HitDamageModifier>({ target != null }, priority = Priority.LOWEST) { player: Player ->
    player["max_hit"] = damage
    damage = damage.coerceAtMost(target!!.levels.get(Skill.Constitution).toDouble())
}