...
combatSwing({ player -> player.fightStyle == "range" && isHandCannon(player.weapon) }, Priority.HIGH) { player: Player ->
...
combatSwing({ player -> !swung() && isHandCannon(player.weapon) }, Priority.LOW) { player: Player ->
...
combatSwing({ player -> !swung() && player.fightStyle == "range" && player.specialAttack && isHandCannon(player.weapon) }, Priority.HIGHISH) { player: Player ->
