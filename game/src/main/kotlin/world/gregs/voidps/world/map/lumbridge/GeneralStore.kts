...
on<NPCOption>({ (npc.def.name == "Shopkeeper" || npc.def.name == "Shop assistant") && option == "Talk-to" }) { player: Player ->
    player.talkWith(npc) {
        ...
        when (choice) {
            ...
            2 -> {
                npc("""
                    I'm glad you ask! The shop has two sections to it:
                    'Main stock' and 'Free sample items'.
                    From 'Main Stock' you can buy as many of the stocked
                    items as you wish.
                """, Expression.Cheerful)
                npc("""
                    I also offer free samples to help get you started
                    and to keep you coming back. Once you take a free sample,
                    I won't give you another for about half an hour.
                    I'm not make of money, you know!
                """, Expression.Laugh)
