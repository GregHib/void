...
combatSwing({ player -> !swung() && player.fightStyle == "range" && isToktz(player.weapon) }, Priority.HIGH) { player: Player ->
...
combatSwing({ player -> !swung() && isToktz(player.weapon) }, Priority.LOW) { player: Player ->
