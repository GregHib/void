...
on<ContainerOption>({ option == "world.gregs.voidps.world.activity.skill.cooking.Empty" }) { player: Player ->
...
on<ContainerOption>({ option == "world.gregs.voidps.world.activity.skill.cooking.Empty Dish" }) { player: Player ->
