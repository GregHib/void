...
import world.gregs.voidps.network.protocol.encode.clanQuickChat
import world.gregs.voidps.network.protocol.encode.privateQuickChatFrom
import world.gregs.voidps.network.protocol.encode.privateQuickChatTo
import world.gregs.voidps.network.protocol.encode.publicQuickChat
