...
object Main {
    ...
    fun main(args: Array<String>) {
        ...
        val tickStages = getTickStages(players, npcs, items, get(), queue, get(), collisions, get(), objectDefinitions, get(), interfaceDefinitions, handler, ParallelIterator(), ParallelIterator())
