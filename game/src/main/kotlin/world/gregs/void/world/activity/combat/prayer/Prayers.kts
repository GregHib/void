...
import world.gregs.void.cache.config.decoder.StructDecoder
...
import world.gregs.void.engine.entity.character.update.visual.player.headIcon
...
import world.gregs.void.world.activity.combat.prayer.PrayerConfigs.ACTIVE_CURSES
import world.gregs.void.world.activity.combat.prayer.PrayerConfigs.ACTIVE_PRAYERS
import world.gregs.void.world.activity.combat.prayer.PrayerConfigs.PRAYERS
import world.gregs.void.world.activity.combat.prayer.PrayerConfigs.QUICK_CURSES
import world.gregs.void.world.activity.combat.prayer.PrayerConfigs.QUICK_PRAYERS
import world.gregs.void.world.activity.combat.prayer.PrayerConfigs.SELECTING_QUICK_PRAYERS
import world.gregs.void.world.activity.combat.prayer.PrayerConfigs.TEMP_QUICK_PRAYERS
...
import world.gregs.void.world.interact.entity.player.display.Tab
