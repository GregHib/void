...
import world.gregs.void.engine.client.ui.closeType
...
import world.gregs.void.world.community.trade.lend.Loan.lendItem
...
fun Player.warn(name: String, component: String, slot: Int) {
    val details: InterfaceDetails = world.gregs.void.utility.get()
    val containerDefinitions: ContainerDefinitions = world.gregs.void.utility.get()
