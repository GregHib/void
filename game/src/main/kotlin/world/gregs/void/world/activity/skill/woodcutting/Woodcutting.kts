package world.gregs.void.world.activity.skill.woodcutting
...
import world.gregs.void.engine.entity.character.player.skill.Level
import world.gregs.void.engine.entity.character.player.skill.Level.has
...
import world.gregs.void.utility.Math
import world.gregs.void.utility.inject
import world.gregs.void.world.activity.skill.woodcutting.tree.RegularTree
import world.gregs.void.world.activity.skill.woodcutting.tree.Tree
import world.gregs.void.world.interact.entity.obj.remove
import world.gregs.void.world.interact.entity.obj.replace
