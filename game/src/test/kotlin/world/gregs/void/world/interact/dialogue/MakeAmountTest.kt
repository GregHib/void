...
import world.gregs.void.world.interact.dialogue.type.makeAmount
...
internal class MakeAmountTest : KoinMock() {
    ...
    @BeforeEach
    fun setup() {
        mockkStatic("world.gregs.void.engine.client.ui.InterfacesKt")
        mockkStatic("world.gregs.void.engine.client.variable.VariablesKt")
