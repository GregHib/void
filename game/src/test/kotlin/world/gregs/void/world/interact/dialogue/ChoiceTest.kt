...
import world.gregs.void.world.interact.dialogue.type.choice
import world.gregs.void.world.interact.dialogue.type.player
...
internal class ChoiceTest : DialogueTest() {
    ...
    override fun setup() {
        super.setup()
        mockkStatic("world.gregs.void.world.interact.dialogue.type.PlayerDialogueKt")
