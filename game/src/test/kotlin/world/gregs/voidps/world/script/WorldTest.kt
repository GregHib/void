...
abstract class WorldTest : KoinTest {
    ...
    fun beforeAll() {
        startKoin {
            ...
            allowOverride(true)
            modules(engineModule, stairsModule, musicModule, bookModule, gameModule, module {
    ...
    companion object {
        ...
        private val huffman: Huffman by lazy { Huffman().load(active.resolve(ActiveCache.indexFile(Indices.HUFFMAN)).readBytes()) }
        ...
        private val extract: MapDefinitions by lazy { MapDefinitions(get(), get(), get()).load(active) }
