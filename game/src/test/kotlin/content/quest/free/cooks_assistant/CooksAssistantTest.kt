...
class CooksAssistantTest : WorldTest() {
    ...
    fun `Complete the quest`() {
        ...
        val prizedDairyCow = objects.find(Tile(3264, 3277), "prized_dairy_cow")
        ...
        val hopper = objects.find(Tile(3166, 3307, 2), "hopper")
        ...
        val hopperControls = objects.find(Tile(3166, 3305, 2), "hopper_controls")
        player.interactObject(hopperControls, "Operate")
        tick()

        player.tele(3165, 3306, 0)
        val flourBin = objects.find(Tile(3166, 3306, 0), "flour_bin_3")
