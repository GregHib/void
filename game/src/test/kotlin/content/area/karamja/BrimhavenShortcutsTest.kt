...
class BrimhavenShortcutsTest : WorldTest() {
    ...
    fun `Swing to brimhaven island`() {
        ...
        val ropeswing = GameObjects.find(Tile(2705, 3209), "brimhaven_ropeswing_west")
    ...
    fun `Swing from brimhaven island`() {
        ...
        player.levels.set(Skill.Agility, 10)
        val ropeSwing = GameObjects.find(Tile(2703, 3205), "brimhaven_ropeswing_east")
    ...
    fun `Cross log balance to red dragons`() {
        ...
        val log = GameObjects.find(Tile(2683, 9506), "brimhaven_log_balance_start")
    ...
    fun `Cross log balance from red dragons`() {
        ...
        player.levels.set(Skill.Agility, 30)
        val log = GameObjects.find(Tile(2686, 9506), "brimhaven_log_balance_end")
