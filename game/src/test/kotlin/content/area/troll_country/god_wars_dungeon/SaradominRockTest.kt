...
class SaradominRockTest : WorldTest() {
    ...
    fun `Tie rope on top rock and climb down`() {
        ...
        val rock = objects.find(Tile(2913, 5300, 2), "godwars_saradomin_rock_top_base")
    ...
    fun `Tie rope on bottom rock and climb down`() {
        ...
        player.inventory.add("rope")
        player.levels.set(Skill.Agility, 70)
        val rock = objects.find(Tile(2920, 5274, 1), "godwars_saradomin_rock_bottom_base")
    ...
    fun `Climb up top rock`() {
        ...
        player.inventory.add("rope")
        val rock = objects.find(Tile(2914, 5300, 1), "godwars_saradomin_rope_top_end_base")
    ...
    fun `Climb up bottom rock`() {
        ...
        player.inventory.add("rope")
        val rock = objects.find(Tile(2920, 5274), "godwars_saradomin_rope_bottom_end_base")
