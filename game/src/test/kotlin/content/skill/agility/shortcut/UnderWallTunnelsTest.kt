...
class UnderWallTunnelsTest : WorldTest() {
    ...
    fun `Climb south under yanille wall`() {
        ...
        val wall = objects.find(Tile(2575, 3111), "yanille_underwall_tunnel_hole")
    ...
    fun `Climb north under yanille wall`() {
        ...
        player.levels.set(Skill.Agility, 15)
        val wall = objects.find(Tile(2575, 3108), "yanille_underwall_tunnel_castle_wall")
    ...
    fun `Climb west under edgeville wall`() {
        ...
        val wall = objects.find(Tile(3143, 3514), "grand_exchange_underwall_tunnel")
    ...
    fun `Climb east under edgeville wall`() {
        ...
        player.levels.set(Skill.Agility, 21)
        val wall = objects.find(Tile(3139, 3516), "edgeville_underwall_tunnel")
    ...
    fun `Climb south under falador wall`() {
        ...
        val wall = objects.find(Tile(2948, 3312), "falador_underwall_tunnel_north")
    ...
    fun `Climb north under falador wall`() {
        ...
        player.levels.set(Skill.Agility, 26)
        val wall = objects.find(Tile(2948, 3310), "falador_underwall_tunnel_south")
