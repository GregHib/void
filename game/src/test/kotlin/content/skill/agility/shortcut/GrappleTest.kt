...
internal class GrappleTest : WorldTest() {
    ...
    fun `Can't grapple to al kharid without mithril grapple`() {
        ...
        val obj = GameObjects.find(Tile(3252, 3179), "lumbridge_broken_raft")
    ...
    fun `Grapple falador wall south`() {
        ...
        player.equipment.set(EquipSlot.Ammo.index, "mithril_grapple")
        player.equipment.set(EquipSlot.Weapon.index, "bronze_crossbow")
        val obj = GameObjects.find(Tile(3005, 3393), "falador_wall_south")
        player.objectOption(obj, "Grapple")
    ...
    fun `Grapple falador wall north`() {
        ...
        player.equipment.set(EquipSlot.Ammo.index, "mithril_grapple")
        player.equipment.set(EquipSlot.Weapon.index, "bronze_crossbow")
        val obj = GameObjects.find(Tile(3006, 3395), "falador_wall_north")
        player.objectOption(obj, "Grapple")
    ...
    fun `Can't jump down falador wall south`() {
        ...
        val obj = GameObjects.find(Tile(3005, 3393, 1), "falador_wall_jump_south")
    ...
    fun `Jump down falador wall north`() {
        ...
        player.levels.set(Skill.Agility, 4)
        val obj = GameObjects.find(Tile(3006, 3395, 1), "falador_wall_jump_north")
        player.objectOption(obj, "Jump")
    ...
    fun `Can grapple from water obelisk to catherby`() {
        ...
        player.equipment.set(EquipSlot.Ammo.index, "mithril_grapple")
        player.equipment.set(EquipSlot.Weapon.index, "bronze_crossbow")
        val obj = GameObjects.find(Tile(2841, 3434), "catherby_crossbow_tree")
        player.objectOption(obj, "Grapple")
    ...
    fun `Can grapple to white wolf mountain`() {
        ...
        player.equipment.set(EquipSlot.Ammo.index, "mithril_grapple")
        player.equipment.set(EquipSlot.Weapon.index, "bronze_crossbow")
        val obj = GameObjects.find(Tile(2869, 3429), "catherby_rocks")
        player.objectOption(obj, "Grapple")
    ...
    fun `Grapple yanille wall south`() {
        ...
        player.equipment.set(EquipSlot.Ammo.index, "mithril_grapple")
        player.equipment.set(EquipSlot.Weapon.index, "bronze_crossbow")
        val obj = GameObjects.find(Tile(2556, 3073), "yanille_grapple_wall")
        player.objectOption(obj, "Grapple")
    ...
    fun `Grapple yanille wall north`() {
        ...
        player.equipment.set(EquipSlot.Ammo.index, "mithril_grapple")
        player.equipment.set(EquipSlot.Weapon.index, "bronze_crossbow")
        val obj = GameObjects.find(Tile(2556, 3075), "yanille_grapple_wall")
        player.objectOption(obj, "Grapple")
    ...
    fun `Jump down yanille wall south`() {
        ...
        player.levels.set(Skill.Agility, 4)
        val obj = GameObjects.find(Tile(2556, 3073, 1), "yanille_grapple_wall_jump")
        player.objectOption(obj, "Jump")
    ...
    fun `Jump down yanille wall north`() {
        ...
        player.levels.set(Skill.Agility, 4)
        val obj = GameObjects.find(Tile(2556, 3075, 1), "yanille_grapple_wall_jump")
        player.objectOption(obj, "Jump")
