...
internal class BarbarianAdvancedTest : WorldTest() {
    ...
    fun `Run up barbarian outpost run wall`() {
        ...
        val pipe = GameObjects.find(Tile(2538, 3541), "barbarian_outpost_run_wall")
    ...
    fun `Climb up wall`() {
        ...
        val pipe = GameObjects.find(Tile(2537, 3546, 2), "barbarian_outpost_climb_wall")
    ...
    fun `Fire spring device`() {
        ...
        val pipe = GameObjects.find(Tile(2532, 3544, 3), "barbarian_outpost_spring")
    ...
    fun `Cross balance beam`() {
        ...
        val pipe = GameObjects.find(Tile(2534, 3553, 3), "barbarian_outpost_balance_beam")
    ...
    fun `Jump over gap`() {
        ...
        val pipe = GameObjects.find(Tile(2537, 3553, 3), "barbarian_outpost_gap")
    ...
    fun `Slide down roof`() {
        ...
        val pipe = GameObjects.find(Tile(2540, 3553, 2), "barbarian_outpost_roof")
    ...
    fun `Finish advanced course lap`() {
        ...
        val pipe = GameObjects.find(Tile(2540, 3552, 2), "barbarian_outpost_roof")
