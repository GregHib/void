...
internal class GnomeAdvancedTest : WorldTest() {
    ...
    fun `Climb up advanced branch`() {
        ...
        val branch = GameObjects.find(Tile(2472, 3419, 2), "gnome_tree_branch_advanced")
    ...
    fun `Run across sign post`() {
        ...
        val sign = GameObjects.find(Tile(2478, 3417, 3), "gnome_sign_post_advanced")
    ...
    fun `Swing across poles`() {
        ...
        val pole = GameObjects.find(Tile(2486, 3425, 3), "gnome_pole_advanced")
    ...
    fun `Jump over barrier`() {
        ...
        val barrier = GameObjects.find(Tile(2485, 3433, 3), "gnome_barrier_advanced")
