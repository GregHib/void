...
> [!NOTE]
> If you want to ask a question, we assume that you have read the available [Wiki](https://greghib.github.io/void/docs) and [Troubleshooting Guide](https://greghib.github.io/void/docs/troubleshooting/) pages.
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment components/versions (Make sure that you have read the [documentation](https://greghib.github.io/void/docs). If you are looking for support, you might want to check [this section](#i-have-a-question)).
...
- Make sure that you are using the latest version.
- Read the [documentation](https://greghib.github.io/void/docs) carefully and find out if the functionality is already covered, maybe by an individual configuration.
...
For content code guidelines see the [Void Wiki](https://greghib.github.io/void/docs) and [Philosophy](https://greghib.github.io/void/docs/philosophy) pages.
