...
1. Set `web.server.enabled` to `true` in `game.properties`.
2. Run the server as normal [^](#quick-setup).
3. Open `http://localhost:8080/play` in the browser and login with any username or password to create a new account.
