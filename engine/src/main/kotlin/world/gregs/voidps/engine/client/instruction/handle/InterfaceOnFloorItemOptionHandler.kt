...
import world.gregs.voidps.engine.entity.character.mode.interact.option.InterfaceOption
...
class InterfaceOnFloorItemOptionHandler(
    ...
    override fun validate(player: Player, instruction: InteractInterfaceFloorItem) {
        ...
        player.mode = Interact(player, floorItem, InterfaceOption(id, component, item, itemSlot, container), approachRange = -1)
    }
}