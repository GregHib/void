...
data class Arg(
    ...
    val autoComplete: (() -> Set<String>)? = null,
    ...
    companion object {
        inline operator fun <reified T : Any> invoke(key: String, optional: Boolean = false, desc: String = "", noinline autoComplete: (() -> Set<String>)? = null) = Arg(
            key,
            when (T::class) {
