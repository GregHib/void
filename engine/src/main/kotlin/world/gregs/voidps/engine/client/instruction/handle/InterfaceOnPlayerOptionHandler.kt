...
import world.gregs.voidps.engine.entity.character.mode.interact.ItemPlayerInteract
...
class InterfaceOnPlayerOptionHandler(
    ...
    override fun validate(player: Player, instruction: InteractInterfacePlayer) {
        ...
        player.mode = ItemPlayerInteract(target, "$id:$component", item, itemSlot, player)
    }
}
