 ...
 */
interface Script : Spawn, Despawn, LevelChanged, Moved, VariableApi, TimerApi, Operation, Approachable, InterfaceInteraction, Death, SettingsReload {
    companion object {
        val interfaces: MutableList<AutoCloseable> = mutableListOf(Spawn, Despawn, LevelChanged, Moved, VariableApi, TimerApi, Operation, Approachable, InterfaceInteraction, Death, SettingsReload)
        fun clear() {
