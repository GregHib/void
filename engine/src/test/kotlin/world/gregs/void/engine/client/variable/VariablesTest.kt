...
internal class VariablesTest {
    ...
    fun setup() {
        ...
        mockkStatic("world.gregs.void.network.codec.game.encode.VarpEncoderKt")
        every { player.sendVarp(any(), any()) } just Runs
        mockkStatic("world.gregs.void.network.codec.game.encode.VarbitEncoderKt")
        every { player.sendVarbit(any(), any()) } just Runs
        mockkStatic("world.gregs.void.network.codec.game.encode.VarcEncoderKt")
        every { player.sendVarc(any(), any()) } just Runs
        mockkStatic("world.gregs.void.network.codec.game.encode.VarcStrEncoderKt")
