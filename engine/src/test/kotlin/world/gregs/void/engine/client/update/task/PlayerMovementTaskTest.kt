...
import world.gregs.void.engine.client.update.task.player.PlayerMovementTask
...
internal class PlayerMovementTaskTest : KoinMock() {
    ...
    fun `Walk step`() {
        ...
        steps.add(Direction.NORTH)
        steps.add(Direction.NORTH)
        mockkStatic("world.gregs.void.engine.entity.character.update.visual.player.MovementType")
        mockkStatic("world.gregs.void.engine.entity.character.update.visual.player.TemporaryMoveType")
        every { player.movement } returns movement
        every { movement.steps } returns steps
