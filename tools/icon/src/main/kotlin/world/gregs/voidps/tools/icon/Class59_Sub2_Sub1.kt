        ...
        if (mesh!!.faceTexSpace != null) {
            ...
            while (i_4_ > i_20_) {
                ...
                if (i_21_ > 0) {
                    ...
                    fs[i_20_] = (KeyedReferenceCache.method1347(mesh.texSpaceDefC!![i_20_].toInt(), mesh.texSpaceDefB!![i_20_].toInt(), f_22_, f_23_, f, mesh.texSpaceDefA!![i_20_].toInt(), Class348_Sub40_Sub17.method1166(255, (mesh.texRotation!![i_20_]).toInt())))
                }
                i_20_++
            }
        }
