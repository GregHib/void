...
internal class Js5Index(`is`: ByteArray?, i: Int, is_27_: ByteArray?) {
    var crc: Int = 0
    var fileIds: Array<IntArray?>
    var groupVersions: IntArray
    var groupNameTable: NameHashTable? = null
    var fileLimits: IntArray
    var fileCounts: IntArray
    var groupCount: Int = 0
    var fileNameTables: Array<NameHashTable?>
    var groupCrcs: IntArray
    var groupHashes: Array<ByteArray?>
    var version: Int = 0
    var groupNames: IntArray
    var groupLimit: Int = 0
    var fileNames: Array<IntArray?>
    var groupIds: IntArray
    private var whirlpool: ByteArray?
