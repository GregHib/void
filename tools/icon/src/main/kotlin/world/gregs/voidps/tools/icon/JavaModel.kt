...
internal class JavaModel : Model {
    private var faceColour: ShortArray?
    private var vertexZ: IntArray
    private var aClass360Array5313: Array<Class360>?
    private var texCoordU: Array<FloatArray>?
    private var anIntArray5315: IntArray
    private var functionMask = 0
    private var faceA: ShortArray
    private var anIntArray5318: IntArray?
    private var aClass101_Sub1_5320: Matrix_Sub1? = null
    private var anIntArray5321: IntArray
    private var emitters: Array<ModelParticleEmitter?>?
    private var aBoolean5323 = false
    private var aShort5324: Short = 0
    private var faceAlpha: ByteArray?
    private var anIntArray5326: IntArray?
    private var faceIndices: ShortArray?
    private var aShort5329: Short = 0
    private var faceLabels: Array<IntArray?>?
    private var aShort5331: Short = 0
    private var vertexY: IntArray
    private var aShortArray5333: ShortArray?
    private var vertexLabels: Array<IntArray?>?
    private var effectors: Array<ModelParticleEffector?>?
    private var anIntArray5337: IntArray
    private var anInt5338 = 0
    private var vertexCount = 0
    private var anInt5342 = 0
    private var anInt5375 = 0
    private var anIntArray5343: IntArray
    private var ambient = 0
    private var texCoordV: Array<FloatArray>?
    ...
    private var anIntArray5355: IntArray
    private var vertexX: IntArray
    private var aBoolean5357 = false
    private var facePriority: ByteArray?
    private var anIntArray5359: IntArray
    private var aClass360Array5360: Array<Class360>?
    private var billboardFaces: Array<JavaBillboardFace>?
    private var anIntArray5362: IntArray
    private var billboardAttributes: Array<JavaBillboardAttributes>
    private var faceC: ShortArray
    private var aShort5365: Short = 0
    private var anIntArray5366: IntArray
    private var aJavaThreadResource_5367: JavaThreadResource? = null
    private var anIntArray5368: IntArray?
    private val aBoolean5369: Boolean
    private var aShortArray5370: ShortArray?
    private var anIntArray5371: IntArray
    private val aBoolean5372: Boolean
    private var anIntArray5373: IntArray
    private var anIntArray5377: IntArray
    private var billboardLabels: Array<IntArray?>?
    private var anIntArray5381: IntArray
    private var transparent: Boolean
    private var rasterizer: Rasterizer? = null
    private var anIntArray5384: IntArray
    private var aClass41Array5385: Array<Class41>?
    private var shadingType: ByteArray?
    private var maxVertex: Int
    private var faceTextures: ShortArray?
    private var billboardCount = 0
    private var movingTextures: Boolean
    private var anIntArray5392: IntArray
    private var aShort5393: Short = 0
    private var faceB: ShortArray
    private var aShort5395: Short = 0
    private var anIntArray5398: IntArray
    private var anIntArray5399: IntArray
    private var anIntArray5400: IntArray?
