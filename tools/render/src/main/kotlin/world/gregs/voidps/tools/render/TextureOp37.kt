...
internal class TextureOp37 : TextureOp(0, true) {
    ...
    override fun method3042(i: Int): IntArray? {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            val i_1_ = -2048 + TextureOpKaleidoscope.anIntArray6035!![i]
            var i_2_ = 0
            while (i_2_ < TextureOpPolarDistortion.anInt9139) {
                val i_3_ = -2048 + TextureOpPerlinNoise.anIntArray6432!![i_2_]
    ...
    private fun method3105(i: Int, i_9_: Int): Boolean {
        ...
        var i_11_ = TextureOpPolarDistortion.anIntArray4654!![(i_10_ * 255 and 0xfff2f) shr 12]
    ...
    private fun method3108(i: Int, i_21_: Int): Boolean {
        ...
        var i_23_ = TextureOpPolarDistortion.anIntArray4654!![(0xff530 and 255 * i_22_) shr 12]
