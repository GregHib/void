...
internal class TextureOpBricks : TextureOp(0, true) {
    ...
    override fun method3042(i: Int): IntArray? {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            ...
            var i_11_ = 0
            var i_12_ = anInt9293 + TextureOpKaleidoscope.anIntArray6035!![i]
            ...
            if (anInt9298 + i_15_ < i_12_ && i_12_ < i_14_ - anInt9298) {
                for (i_16_ in 0..<TextureOpPolarDistortion.anInt9139) {
                    var i_17_ = 0
                    val i_18_ = if (!bool) -anInt9288 else anInt9288
                    var i_19_ = TextureOpPerlinNoise.anIntArray6432!![i_16_] + (i_18_ * anInt9291 shr 12)
                ...
                TextureOpIrregularBricks.method1579(`is`, 0, TextureOpPolarDistortion.anInt9139, 0)
            }
        }
        return `is`
    }
