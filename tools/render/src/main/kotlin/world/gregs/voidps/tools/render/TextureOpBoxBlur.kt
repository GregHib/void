...
internal class TextureOpBoxBlur : TextureOp(1, false) {
    ...
    override fun method3042(i: Int): IntArray? {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            ...
            for (i_19_ in -anInt9463 + i..i - -anInt9463) {
                val is_20_ = this.method3048(TextureOpPolarDistortion.anInt6325 and i_19_, 0)!!
                val is_21_ = IntArray(TextureOpPolarDistortion.anInt9139)
                var i_22_ = 0
            ...
            var i_25_ = 0
            while (TextureOpPolarDistortion.anInt9139 > i_25_) {
                var i_26_ = 0
    ...
    override fun method3047(i: Int): Array<IntArray>? {
        ...
        if (this.aColourImageCache_7033!!.aBoolean4035) {
            ...
            for (i_34_ in i + -anInt9463..anInt9463 + i) {
                val is_35_ = this.method3039(TextureOpPolarDistortion.anInt6325 and i_34_, 0)
                val is_36_: Array<IntArray> = Array(3) { IntArray(TextureOpPolarDistortion.anInt9139) }
                var i_37_ = 0
                var i_38_ = 0
                var i_39_ = 0
                val is_40_ = is_35_!![0]
            ...
            val is_52_ = `is`[2]
            var i_53_ = 0
            while (TextureOpPolarDistortion.anInt9139 > i_53_) {
                var i_54_ = 0
                var i_55_ = 0
                var i_56_ = 0
