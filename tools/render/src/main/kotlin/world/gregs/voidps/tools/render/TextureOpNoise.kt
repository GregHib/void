...
internal class TextureOpNoise : TextureOp(0, true) {
    ...
    override fun method3042(i: Int): IntArray {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            val i_4_ = TextureOpKaleidoscope.anIntArray6035!![i]
            var i_5_ = 0
            while ((i_5_ < TextureOpPolarDistortion.anInt9139)) {
                `is`!![i_5_] = method3103(i_4_, TextureOpPerlinNoise.anIntArray6432!![i_5_]) % 4096
                i_5_++
            }
        }
        return `is`!!
