...
class TextureOpColorGradient : TextureOp(1, false) {
    ...
    override fun method3047(i: Int): Array<IntArray>? {
        ...
        if (this.aColourImageCache_7033!!.aBoolean4035) {
            ...
            while ((TextureOpPolarDistortion.anInt9139 > i_8_)) {
                ...
                is_5_[i_8_] = TextureOpSprite.method1166(i_9_, 16711680) shr 12
                is_6_[i_8_] = TextureOpSprite.method1166(65280, i_9_) shr 4
                is_7_[i_8_] = TextureOpSprite.method1166(4080, i_9_ shl 4)
                i_8_++
            }
        }
        return `is`
