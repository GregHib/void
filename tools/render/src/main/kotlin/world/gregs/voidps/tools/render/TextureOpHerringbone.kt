...
/** Class348_Sub40_Sub2 **/
internal class TextureOpHerringbone : TextureOp(0, true) {
    ...
    override fun method3042(i: Int): IntArray? {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            for (i_3_ in 0..<TextureOpPolarDistortion.anInt9139) {
                val i_4_ = TextureOpPerlinNoise.anIntArray6432!![i_3_]
                val i_5_ = TextureOpKaleidoscope.anIntArray6035!![i]
