...
/** Class348_Sub40_Sub8 **/
internal class TextureOpPerlinNoise : TextureOp(0, true) {
                ...
                while_149_@ do {
                    while_148_@ do {
                        while_147_@ do {
                            do {
                                if (i_1_ == 0) {
                                    this.aBoolean9160 = packet!!.readUnsignedByte() == 1
                                    break@while_151_
                                } else if (i_1_ != 1) {
                                    if (i_1_ != 2) {
                                        if (i_1_ != 3) {
                            ...
                            this.anInt9149 = packet!!.readShort()
                            if (this.anInt9149 < 0) {
                                aShortArray9159 = ShortArray((this.anInt9150))
                                i_1_ = 0
                                while ((this.anInt9150 > i_1_)) {
                                    aShortArray9159!![i_1_] = packet.readShort().toShort()
                                    i_1_++
                                }
                            }
                            break@while_151_
                        } while (false)
                        this.anInt9164 = packet!!.readUnsignedByte()
                        this.anInt9158 = this.anInt9164
                        break@while_151_
                    } while (false)
                    this.anInt9156 = packet!!.readUnsignedByte()
                    break@while_151_
                } while (false)
                this.anInt9158 = packet!!.readUnsignedByte()
                break@while_151_
            } while (false)
            this.anInt9164 = packet!!.readUnsignedByte()
        } while (false)
    ...
    override fun method3042(i: Int): IntArray {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) method3069(i, `is`!!)
        return `is`!!
    }
    ...
    fun method3069(i: Int, `is`: IntArray) {
        val i_9_ = (TextureOpKaleidoscope.anIntArray6035!![i] * this.anInt9164)
        if (this.anInt9150 == 1) {
            ...
            if (this.aBoolean9160) {
                var i_52_ = 0
                while ((TextureOpPolarDistortion.anInt9139 > i_52_)) {
                    val i_53_ = (this.anInt9158 * anIntArray6432!![i_52_])
                    var i_54_ = method3070(i_46_, i_41_, i_42_, i_53_ * i_39_ shr 12, i_47_, i_48_)
                    i_54_ = i_40_ * i_54_ shr 12
                    `is`[i_52_] = (i_54_ shr 1) + 2048
                    i_52_++
                }
            } else {
                for (i_49_ in 0..<TextureOpPolarDistortion.anInt9139) {
                    val i_50_ = (this.anInt9158 * anIntArray6432!![i_49_])
                    val i_51_ = method3070(i_46_, i_41_, i_42_, i_39_ * i_50_ shr 12, i_47_, i_48_)
            ...
            if (i_10_ > 8 || i_10_ < -8) {
                ...
                while (TextureOpPolarDistortion.anInt9139 > i_20_) {
                    ...
                    val i_22_ = method3070(i_17_, i_12_, i_13_, i_11_ * i_21_ shr 12, i_19_, i_18_)
            ...
            while (this.anInt9150 > i_23_) {
                ...
                if (i_10_ > 8 || i_10_ < -8) {
                    ...
                    if (this.aBoolean9160 && (this.anInt9150 - 1 == i_23_)) {
                        var i_33_ = 0
                        while (TextureOpPolarDistortion.anInt9139 > i_33_) {
                            val i_34_ = (anIntArray6432!![i_33_] * (this.anInt9158))
                            var i_35_ = method3070(i_32_, i_25_, i_26_, i_34_ * i_24_ shr 12, i_31_, i_30_)
                        ...
                        var i_36_ = 0
                        while ((i_36_ < TextureOpPolarDistortion.anInt9139)) {
                            val i_37_ = (this.anInt9158 * anIntArray6432!![i_36_])
                            val i_38_ = method3070(i_32_, i_25_, i_26_, i_37_ * i_24_ shr 12, i_31_, i_30_)
    ...
    private fun method3070(i: Int, i_55_: Int, i_56_: Int, i_57_: Int, i_58_: Int, i_59_: Int): Int {
        var i_57_ = i_57_
    ...
    companion object {
        ...
        init {
            for (i in 0..4095) anIntArray2631[i] = method1918(i)
        }
    }
}
