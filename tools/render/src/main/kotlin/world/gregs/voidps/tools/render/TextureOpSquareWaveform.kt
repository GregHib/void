...
internal class TextureOpSquareWaveform : TextureOp(0, true) {
    ...
    override fun method3042(i: Int): IntArray {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            val i_1_ = TextureOpKaleidoscope.anIntArray6035!![i]
            if (anInt9325 == 0) {
                var i_7_ = 0
                ...
                TextureOpIrregularBricks.method1579(`is`!!, 0, TextureOpPolarDistortion.anInt9139, i_7_)
            } else {
                for (i_2_ in 0..<TextureOpPolarDistortion.anInt9139) {
                    var i_3_ = 0
                    var i_4_ = 0
                    val i_5_ = TextureOpPerlinNoise.anIntArray6432!![i_2_]
                    var i_6_ = anInt9325
                    while_197_@ do {
                        do {
                            if (i_6_ == 1) {
