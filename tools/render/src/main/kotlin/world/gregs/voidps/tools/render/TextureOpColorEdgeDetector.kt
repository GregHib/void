...
internal class TextureOpColorEdgeDetector : TextureOp(1, false) {
    ...
    override fun method3047(i: Int): Array<IntArray>? {
        ...
        if (this.aColourImageCache_7033!!.aBoolean4035) {
            val is_8_ = this.method3048(-1 + i and TextureOpPolarDistortion.anInt6325, 0)!!
            val is_9_ = this.method3048(i, 0)!!
            val is_10_ = this.method3048(TextureOpPolarDistortion.anInt6325 and 1 + i, 0)!!
            val is_11_ = `is`!![0]
            val is_12_ = `is`[1]
            val is_13_ = `is`[2]
            var i_14_ = 0
            while (TextureOpPolarDistortion.anInt9139 > i_14_) {
                ...
                val i_16_ = (anInt9438 * (is_9_[1 + i_14_ and TextureOpBoxBlur.anInt6076] - is_9_[TextureOpBoxBlur.anInt6076 and -1 + i_14_]))
