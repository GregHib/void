...
internal class TextureOpIrregularBricks : TextureOp(0, true) {
    ...
    private fun method3112(i_2_: Int, `is`: Array<IntArray?>, random: Random, i_3_: Int, i_4_: Int, i_5_: Int) {
        var i_3_ = i_3_
        val width = TextureOpPolarDistortion.anInt9139
        val mask = TextureOpBoxBlur.anInt6076
    ...
    override fun method3042(i: Int): IntArray? {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            val width = TextureOpPolarDistortion.anInt9139
            val height = TextureOpKaleidoscope.anInt6212
            val is_42_ = this.aMonochromeImageCache_7032!!.method1427()!!
            var i_43_ = 0
            var i_44_ = 0
            var i_45_ = 0
            var i_46_ = 0
