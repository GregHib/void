...
internal class TextureOpMandelbrot : TextureOp(0, true) {
    ...
    override fun method3042(i: Int): IntArray? {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            var i_3_ = 0
            while (i_3_ < TextureOpPolarDistortion.anInt9139) {
                val i_4_ = anInt9339 + (TextureOpPerlinNoise.anIntArray6432!![i_3_] shl 12) / anInt9340
                val i_5_ = anInt9338 + (TextureOpKaleidoscope.anIntArray6035!![i] shl 12) / anInt9340
                val i_6_ = i_4_
                val i_7_ = i_5_
                var i_8_ = i_4_
                var i_9_ = i_5_
