...
/** Class348_Sub40_Sub7 **/
internal class TextureOpFlip : TextureOp(1, false) {
    ...
    override fun method3047(i: Int): Array<IntArray>? {
        ...
        if (this.aColourImageCache_7033!!.aBoolean4035) {
            val is_1_ = this.method3039(if (aBoolean9147) -i + TextureOpPolarDistortion.anInt6325 else i, 0)!!
            val is_2_ = is_1_[0]
            val is_3_ = is_1_[1]
            val is_4_ = is_1_[2]
            val is_5_ = `is`!![0]
            ...
            val is_7_ = `is`[2]
            if (aBoolean9140) {
                for (i_8_ in 0..<TextureOpPolarDistortion.anInt9139) {
                    is_5_[i_8_] = is_2_[TextureOpBoxBlur.anInt6076 - i_8_]
                    is_6_[i_8_] = is_3_[TextureOpBoxBlur.anInt6076 - i_8_]
                    is_7_[i_8_] = is_4_[TextureOpBoxBlur.anInt6076 - i_8_]
                }
            } else {
    ...
    override fun method3042(i: Int): IntArray? {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            val is_76_ = this.method3048(if (aBoolean9147) TextureOpPolarDistortion.anInt6325 - i else i, 0)!!
            if (aBoolean9140) {
                for (i_77_ in 0..<TextureOpPolarDistortion.anInt9139) `is`!![i_77_] = is_76_[TextureOpBoxBlur.anInt6076 - i_77_]
            } else {
                // Class214.method1578 in the client (an arraycopy)
                System.arraycopy(is_76_, 0, `is`!!, 0, TextureOpPolarDistortion.anInt9139)
            }
        }
        return `is`
    }
