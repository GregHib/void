...
internal class TextureOpLineNoise : TextureOp(0, true) {
    ...
    override fun method3044() {
        TextureOpPolarDistortion.method1605()
    }
    ...
    override fun method3042(i: Int): IntArray? {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            ...
            val is_4_ = this.aMonochromeImageCache_7032!!.method1427()
            ...
            while (anInt9362 > i_5_) {
                ...
                var i_7_: Int = Mesh.method1097(TextureOpPolarDistortion.anInt9139, random)
                var i_8_: Int = Mesh.method1097(TextureOpKaleidoscope.anInt6212, random)
                var i_9_ = i_7_ - -(anInt9368 * TextureOpPolarDistortion.anIntArray4654!![i_6_] shr 12)
                var i_10_ = ((TextureOpPolarDistortion.anIntArray3068!![i_6_] * anInt9368 shr 12) + i_8_)
