...
/** Class348_Sub40_Sub36 **/
internal class TextureOpWaveform : TextureOp(0, true) {
    ...
    override fun method3042(i: Int): IntArray? {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            val i_3_ = TextureOpKaleidoscope.anIntArray6035!![i]
            val i_4_ = -2048 + i_3_ shr 1
            var i_5_ = 0
            while (i_5_ < TextureOpPolarDistortion.anInt9139) {
                val i_6_ = TextureOpPerlinNoise.anIntArray6432!![i_5_]
                ...
                if (anInt9455 != 0) {
                    ...
                    i_8_ = 4096 + (TextureOpPolarDistortion.anIntArray3068!![i_8_ shr 4 and 0xff]) shr 1
                }
                `is`!![i_5_] = i_8_
                i_5_++
            }
