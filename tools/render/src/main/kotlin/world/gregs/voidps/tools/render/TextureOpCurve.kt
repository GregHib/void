...
/** Class348_Sub40_Sub14 **/
internal class TextureOpCurve : TextureOp(1, true) {
        ...
        while_158_@ do {
            do {
                ...
                while (i_2_ < 257) {
                    ...
                    val i_24_ = (-(TextureOpPolarDistortion.anIntArray4654!![(i_23_ and 0x1ff6) shr 5]) + 4096 shr 1)
    ...
    override fun method3042(i: Int): IntArray {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            ...
            for (i_35_ in 0..<TextureOpPolarDistortion.anInt9139) {
