...
/** Class348_Sub40_Sub5 **/
internal class TextureOpVoronoiNoise : TextureOp(0, true) {
    ...
    override fun method3042(i: Int): IntArray {
        ...
        if (this.aMonochromeImageCache_7032!!.aBoolean2570) {
            val i_1_ = anInt9117 * TextureOpKaleidoscope.anIntArray6035!![i] + 2048
            ...
            while_140_@ while ( /**/TextureOpPolarDistortion.anInt9139 > i_4_) {
                ...
                anInt2835 = anInt2023
                anInt9715 = anInt2835
                val i_5_ = 2048 - -(TextureOpPerlinNoise.anIntArray6432!![i_4_] * anInt9129)
