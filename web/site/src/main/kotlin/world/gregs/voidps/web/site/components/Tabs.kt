...
fun Ui.tabs(model: String, items: List<TabItem>, filled: Boolean = true, onSelect: ((String) -> String)? = null) {
    receiver.div {
        ...
        style = "display:flex;align-items:stretch;gap:var(--space-1);border-bottom:1px solid var(--border-panel);" +
        ...
        for (item in items) {
            button {
                ...
                style = "height:42px;padding:0 18px;display:inline-flex;align-items:center;gap:var(--space-4);" +
