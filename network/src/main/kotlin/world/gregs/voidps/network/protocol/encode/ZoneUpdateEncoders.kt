...
import world.gregs.voidps.network.protocol.encode.zone.*
...
suspend fun ByteWriteChannel.encode(update: ZoneUpdate) {
    when (update) {
        ...
        is world.gregs.voidps.network.protocol.encode.zone.FloorItemRemoval -> floorItemRemoval(update) // update
...
private suspend fun ByteWriteChannel.floorItemRemoval(update: world.gregs.voidps.network.protocol.encode.zone.FloorItemRemoval) {
