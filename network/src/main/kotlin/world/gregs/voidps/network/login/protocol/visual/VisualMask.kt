...
object VisualMask {
    ...
    val PLAYER_GRAPHIC_MASKS = intArrayOf(
        PLAYER_GRAPHIC_1_MASK,
        PLAYER_GRAPHIC_2_MASK,
        PLAYER_GRAPHIC_3_MASK,
        PLAYER_GRAPHIC_4_MASK
    )
    ...
    val NPC_GRAPHIC_MASKS = intArrayOf(
        NPC_GRAPHIC_1_MASK,
        NPC_GRAPHIC_2_MASK,
        NPC_GRAPHIC_3_MASK,
        NPC_GRAPHIC_4_MASK
